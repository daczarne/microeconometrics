...
###########################################################################
# IMPORTANT NOTE!!! HERE IS SOME CODE FOR THIS TO WORK LOCALLY. YOU SHOULD ONLY NEED THIS CODE FOR LOCAL TESTING. PLEASE REFER TO THE FLASK_DANCE DOCS FOR MORE INFO
###########################################################################
...
@app.route("/welcome")
def welcome():
	# Internal server error (just for demo)
